				...
				<form method="post" action="../controller/moderador.php">
					<div class="row">
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" name="nm-moderador" required value="<?php echo $moderador['nm-moderador'];?>">
						</div>
						<div class="form-group col-md-3">
							<label for="campo2">Data de Nascimento</label>
							<input type="date" class="form-control" name="dt-nascimento" required value="<?php echo $moderador['dt-nascimento'];?>">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-4">
							<label for="campo3">Insituição</label>
							<input type="text" class="form-control" name="cd-instituicao" required value="<?php echo $moderador['cd-instituicao'];?>">
						</div>
					</div>
					<div class="row">	
						<div class="form-group col-md-3">
							...
							<select name="nm-funcao" class="form-control" required>
								...
								<option value="Professor" <?php if ($moderador['nm-funcao'] == "Professor") echo "selected" ?>>
									Professor
								</option>
								<option value="Facilitador" <?php if ($moderador['nm-funcao'] == "Facilitador") echo "selected" ?>>
									Facilitador
								</option>
								<option value="Outra Função" <?php if ($moderador['nm-funcao'] == "Outra Função") echo "selected" ?>>
									Outra Função
								</option>
							</select>
						</div>
						...
						<div class="form-group col-md-3">
							...
							<input type="email" class="form-control" name="email" required value="<?php echo $moderador['email'];?>">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-3">
							<label for="campo6">Período Moderação (Inicial)</label>
							<input type="date" class="form-control" name="dt-ini-periodo" required value="<?php echo $moderador['dt-ini-periodo'];?>">
							
						</div>
						
						<div class="form-group col-md-3">
							<label for="campo7">Período Moderação (Final)</label>
							<input type="date" class="form-control" name="dt-fim-periodo" required value="<?php echo $moderador['dt-fim-periodo'];?>">
					...
					<div class="row">
						<div class="form-group col-md-4">
							...
							<textarea rows="4" cols="50" class="form-control" name="des-experiencia" required><?php echo $moderador['des-experiencia'];?></textarea>
						</div>
					</div>
					<div class="row">	
						<div class="form-group col-md-4">
