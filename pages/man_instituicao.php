...
<head>
	...
	<title>Manutenção de Instituições</title>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modalLabel">Excluir Instituição</h4>
				</div>
				<div class="modal-body">Deseja realmente excluir esta Instituição? </div>
		...
		<div id="top" class="row">
			...
			<div class="col-md-6">
				<div class="input-group h2">
					<input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar Instituição">
